...
/// <summary>
/// Reads data from and sends mutations to the KeyEngine admin API.
/// </summary>
public interface IAdminApiClient
{
    /// <summary>Gets or sets the optional admin token sent with mutation requests.</summary>
